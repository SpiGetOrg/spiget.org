...
series:a})}})}var a=Cookies.get("statsApiVersion");void 0===a&&(a="v2");$("#api_version_selector").val(a);var c={status:"https://api.spiget.org/v2/status?spiget__ua=SpigetStatus&callback=?",spigot_status:"https://api.spiget.org/spigotStatus.php?spiget__ua=SpigetStatus&callback=?",metrics:"https://api.spiget.org/"+a+"/metrics/requests/30?spiget__ua=SpigetStatus&pretty=false"},l={page_size:20,seconds_per_resource:20,update_interval:2},a=Cookies.get("showFullUserAgent");if(void 0===a||"true"!==a)c.metrics+=
