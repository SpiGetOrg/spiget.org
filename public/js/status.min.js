...
followTouchMove:!0,formatter:b,useHTML:!0},series:[{name:"total",data:a}]});$("#user_agent_requests_collapse").collapse("show");a=[];for(d in g){value=g[d];var k=[],e;for(e in value)value1=value[e],e=parseInt(e.trim()),date=1E3*e,k.push([date,value1]);a.push({name:d,data:k})}$("#user_agent_requests_graph").highcharts({chart:{type:"spline",zoomType:"x"},legend:{enabled:"true"===Cookies.get("enableLegend")},plotOptions:{series:{marker:{enabled:!1,symbol:"circle",states:{hover:{enabled:!0}}}}},title:{text:"Requests per User-Agent"},
xAxis:{type:"datetime"},yAxis:{title:{text:"Number of Requests"},min:0},tooltip:{backgroundColor:{linearGradient:[0,0,0,60],stops:[[0,"#FFFFFF"],[1,"#E0E0E0"]]},crossshairs:[!0,!0],shared:!0,followPointer:!0,followTouchMove:!0,formatter:b,useHTML:!0},series:a});$("#method_requests_collapse").collapse("show");a=[];for(d in h){value=h[d];k=[];for(e in value)value1=value[e],e=parseInt(e.trim()),date=1E3*e,k.push([date,value1]);a.push({name:d,data:k})}$("#method_requests_graph").highcharts({chart:{type:"spline",
zoomType:"x"},legend:{enabled:"true"===Cookies.get("enableLegend")},plotOptions:{series:{marker:{enabled:!1,symbol:"circle",states:{hover:{enabled:!0}}}}},title:{text:"Requests per Method"},xAxis:{type:"datetime"},yAxis:{title:{text:"Number of Requests"},min:0},tooltip:{backgroundColor:{linearGradient:[0,0,0,60],stops:[[0,"#FFFFFF"],[1,"#E0E0E0"]]},crossshairs:[!0,!0],shared:!0,followPointer:!0,followTouchMove:!0,formatter:b,useHTML:!0},series:a})}})}var a=Cookies.get("statsApiVersion");void 0===
a&&(a="v2");$("#api_version_selector").val(a);var c={status:"https://api.spiget.org/v2/status?spiget__ua=SpigetStatus&callback=?",spigot_status:"https://api.spiget.org/spigotStatus.php?spiget__ua=SpigetStatus&callback=?",metrics:"https://api.spiget.org/"+a+"/metrics/requests/30?spiget__ua=SpigetStatus&pretty=false"},l={page_size:20,seconds_per_resource:20,update_interval:2},a=Cookies.get("showFullUserAgent");if(void 0===a||"true"!==a)c.metrics+="&stripUaVersion=true";a=Cookies.get("hourlyRequests");
void 0!==a&&"true"===a&&(c.metrics+="&hourly");var a=Cookies.get("forceLiveData"),q=!1;void 0!==a&&"true"===a&&(c.metrics+="&callback=?",q=!0);$("#api_version_selector").change(function(){Cookies.set("statsApiVersion",$(this).val(),{expires:356});location.reload()});m(2);$("#user_agent_graph_expand").click(function(a){a.preventDefault();$("#user_agent_requests_graph").highcharts().setSize($($("#user_agent_requests_graph").highcharts().container).width(),1E3)})});
