window.webhook={loadEvents:function(){$.ajax({url:"https://api.spiget.org/v2/webhook/events?spiget__ua=SpigetWebhooks&callback=?",dataType:"jsonp",success:function(b){$.each(b.events,function(a,d){$("#events_group").append("<input type='checkbox' class='webhook-event' value='"+d+"'> "+d+"<br/>")})}})},ignoreConnection:!1,testConnection:function(b,a,d){webhook.ignoreConnection?d(!0):($("#registerButton").prop("disabled",!0),Alert.alert("info","Testing connection...",!0),$.ajax({url:"https://tools.inventivetalent.org/connection/ping.php?spiget__ua=SpigetWebhooks&callback=?&method=POST&url="+
