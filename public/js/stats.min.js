...
dataType:"json",success:function(a){count=total=0;$.each(a,function(a,d){0<d.total&&(total+=d.total,count+=1)});avg=0<total&&0<count?total/count:0;rounded=Math.round(avg);$("#stat_daily_requests").stop();animateValue("#stat_daily_requests",rounded,1500)}});$.ajax({url:"https://api.spiget.org/v2/resources/recentUpdates?spiget___ua=SpigetStats&size=16&pretty=false&callback=?",dataType:"jsonp",success:function(a){var c=0;$.each(a,function(a,b){isArray(b)||(c+=1,$("#new-resources").append("<li>\t<a target='_blank' href='https://r.spiget.org/"+
...
$.ajax({url:"https://api.spiget.org/v2/authors/recentUpdates?spiget___ua=SpigetStats&size=16&pretty=false&callback=?",dataType:"jsonp",success:function(a){var c=0;$.each(a,function(a,b){isArray(b)||(c+=1,$("#new-authors").append("<li>\t<a target='_blank' href='https://a.spiget.org/"+b.id+"'>"+b.name+"</a></li>"))});0===c&&$("#new-authors").append("<li>\t<span class='text-muted'>No new authors since the last update</span></li>")}})},500);var a=1;setInterval(function(){0<$("#hidden_test").is(":visible")?
